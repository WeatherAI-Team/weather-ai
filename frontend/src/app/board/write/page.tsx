...
function WriteForm() {
  ...
  const handleSubmit = async () => {
    ...
    if (!localUser)                            { alert('로그인이 필요합니다.'); return }
    ...
    try {
      ...
      router.push(editId ? `/board/${editId}` : '/board')
    } catch (e: any) {
    ...
    <div className={styles.wrapper}>
      <div className={styles.container}>
        ...
        <div className={styles.header}>
          ...
          <h2 className={styles.heading}>{editId ? '게시글 수정' : '글쓰기'}</h2>
        </div>
        ...
        <div className={styles.field}>
          ...
          <div className={styles.editorWrap}>
            ...
            <div className={styles.toolbar}>
              ...
              <div className={styles.divider} />
              <button onMouseDown={e => { e.preventDefault(); exec('justifyLeft') }}   className={styles.toolBtn} title="왼쪽">≡좌</button>
              <button onMouseDown={e => { e.preventDefault(); exec('justifyCenter') }} className={styles.toolBtn} title="가운데">≡중</button>
              <button onMouseDown={e => { e.preventDefault(); exec('justifyRight') }}  className={styles.toolBtn} title="오른쪽">≡우</button>
              <div className={styles.divider} />
