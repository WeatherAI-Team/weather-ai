...
export default function MyPostsPage() {
  useEffect(() => {
    document.title = "Weather AI - 내 게시글";
  }, []);
  ...
  const visiblePosts = isUser
    ? posts.filter((p) => p.board_type === "FREE")
    : posts;
                  ...
                  filtered.map((p) => (
                    ...
                    >
                      <td className={styles.td}>
                        <span className={styles.idChip}>{p.id}</span>
                      </td>
                      <td className={styles.td}>
                        <span
                          className={`${styles.boardBadge} ${styles[TYPE_COLOR[p.board_type] ?? "suggest"]}`}
                        >
          ...
          <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
            <div className={styles.modalHeader}>
              <div className={styles.modalMeta}>
                <span
                  className={`${styles.boardBadge} ${styles[TYPE_COLOR[detailPost.board_type] ?? "suggest"]}`}
                >
            ...
            <div className={styles.modalFooter}>
              <span className={styles.modalViews}>
                조회 {detailPost.view_count.toLocaleString()}
              </span>
              <Link
                href={`/board/${detailPost.id}`}
